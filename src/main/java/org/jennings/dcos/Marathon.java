...
public class Marathon {
        ...
        try {
            ...
            while (k < ports.length() && brokers.isEmpty()) {
                try {
                    ...
                    // Modified to support changes with beta-kafka
    ...
    public String getElastic5Info(String esAppName, String username, String password) {
        ...
        try {
            ...
            returnJson.put("eip", eip + ":" + port);

            url = "http://" + eip + ":" + port + "/v1/endpoints/data-http";
            System.out.println(url);
            ...
            json = new JSONObject(result.toString());
            String address = json.getJSONArray("http").getString(0);
    ...
    public static void main(String[] args) {
        ...
        if (numargs != 2 && numargs != 4) {
            System.err.print("Usage: MarathonInfo <kafka|elastic|elastic5> <framework-name>\n");
        } else {
